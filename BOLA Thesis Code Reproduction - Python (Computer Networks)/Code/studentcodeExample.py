...
# Debugged by SHI Wenlan: fixed the bug of prevmatch
...
def bufferbased(rate_prev, buf_now, r, R_i, cu=126):
    ...
    # print("rate_prev before: ",rate_prev)
    rate_prev = prevmatch(rate_prev, R_i)
    # print("rate_prev after: ",rate_prev)
    ...
    # check if big enough get a different reasonable rate
    ...
    # check if small enough for a different reasonable rate
