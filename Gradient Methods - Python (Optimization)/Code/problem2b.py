...
def gradient_method(flag, x_values):
    count = 1
    xk = x0
    x_values.append(xk)
...
if __name__ == '__main__':
    ...
    x0 = Xs[0]
    gradient_method(True, X1s)
    x0 = Xs[1]
    gradient_method(True, X2s)
    x0 = Xs[2]
    gradient_method(True, X3s)
    x0 = Xs[3]
    gradient_method(True, X4s)
    draw(X1s, X2s, X3s, X4s, "Exact line search method")
    ...
    x0 = Xs[0]
    gradient_method(False, X1s)
    x0 = Xs[1]
    gradient_method(False, X2s)
    x0 = Xs[2]
    gradient_method(False, X3s)
    x0 = Xs[3]
    gradient_method(False, X4s)
    draw(X1s, X2s, X3s, X4s, "Backtraking / Armijo line search method")
