...
#define PHYSICAL_MEM_SIZE (1 << 15) // PHYSICAL_MEM_SIZE = 32,768
// 128 KB in global memory
#define STORAGE_SIZE (1 << 17)  // STORAGE_SIZE = 131072
